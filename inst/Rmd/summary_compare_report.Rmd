...
for(current_cohort in cohorts)
{
  ...
  for(current_cat in categories)
  {
    ...
    current_source_dataset_sheet <- harmonization_sheet[harmonization_sheet$study == current_cohort & harmonization_sheet$item == current_cat,c('visit','source_dataset')]
    
    # Check for semicolon
    
    if(any(grepl(pattern = ';', x = current_source_dataset_sheet$source_dataset)))
    {
