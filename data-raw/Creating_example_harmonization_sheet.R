##
## Creating_example_harmonization_sheet.R
##
## 1/7/2022
##
## Creating a harmonization sheet to demonstrate using the example datasets
##
...
# Combine -----------
harmonization_sheet_example <- bind_rows(harm_sheet_cohort_a, harm_sheet_cohort_b, harm_sheet_cohort_c)

# Saving ------------

usethis::use_data(harmonization_sheet_example)
